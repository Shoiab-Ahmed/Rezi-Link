  ...
  return (
    <div className=' w-[90%] mx-auto '>
          ...
          <div className='flex flex-row gap-[20px] mt-[20px]'>
            <div className=' flex flex-col justify-between w-[305px] h-[196px] rounded-[24px] bg-[#272727] text-white px-[20px] py-[21px]'>
              <div className='flex justify-between items-center'>
                <p className='text-[18px] w-[170px] h-[27px] leading-[150%] '>lots of cool options</p>
              ...
              <p className=' w-full text-[50px] leading-[150%] flex justify-between items-center'>375k + <span className='text-[18px] text-[#B3B3B3]'>Collection</span> </p>
            ...
            <div className='flex flex-row gap-[20px] mt-[20px'>
              <div className=' flex flex-col justify-between w-[305px] h-[196px] rounded-[24px] bg-[#272727] text-white px-[20px] py-[21px]' >
                <div className='flex justify-between items-center'>
                  <p className='text-[18px] w-[170px] h-[27px] leading-[150%] '>Happy Customer</p>
                  <div className='flex justify-center items-center w-[54px] h-[54px]   hover:rounded-full hover:bg-[#A0CAF5]'><MdArrowOutward /></div>
                </div>
                <div className='flex justify-between items-center'>

                  <h1 className=' w-full text-[50px] leading-[150%] flex justify-between items-center'>1.5 M +</h1>
      ...
      <div className=' w-[90%] mx-auto grid grid-cols-2 gap-[50px]  my-[140px]'>
        <div >
          <p className='text-[55px]'>Style the house you <br /> want for the deal</p>
        </div>
        <div className='w-[600px] h-[120px]'>
          <p className='text-[20px] text-[#272727B2]'>consists of several categories of homes that you want to determine your comfort with family. So home is your palace. So you can spend time with your family at home and play with children.</p>
        ...
        <div className='px-[63px] py-[40px] w-[611px] h-[302px] bg-[#272727] rounded-[24px]'>
          <div className='grid grid-cols-2 gap-[30px] text-white text-[36px]'>
            <button className='flex justify-between'>Elegant <div className='flex justify-center items-center w-[54px] h-[54px]   hover:rounded-full hover:bg-[#A0CAF5]'><MdArrowOutward /></div>
            </button>
            <button className='flex justify-between'>Casstle<div className='flex justify-center items-center w-[54px] h-[54px]   hover:rounded-full hover:bg-[#A0CAF5]'><MdArrowOutward /></div>
            </button>
            <button className='flex justify-between'>Custle <div className='flex justify-center items-center w-[54px] h-[54px]   hover:rounded-full hover:bg-[#A0CAF5]'><MdArrowOutward /></div>
            </button>
            <button className='flex justify-between'>Modern<div className='flex justify-center items-center w-[54px] h-[54px]   hover:rounded-full hover:bg-[#A0CAF5]'><MdArrowOutward /></div>
            </button>
            <button className='flex justify-between'>American<div className='flex justify-center items-center w-[54px] h-[54px]   hover:rounded-full hover:bg-[#A0CAF5]'><MdArrowOutward /></div>
            </button>
            <button className='flex justify-between'>Culture<div className='flex justify-center items-center w-[54px] h-[54px]   hover:rounded-full hover:bg-[#A0CAF5]'><MdArrowOutward /></div>
            </button>
      ...
      <h1 className='text-[55px]'>Choose your home now</h1>

      
      <div className='grid grid-cols-3 gap-[50px]'>
        <div style={{backgroundImage:`url(${firstimage})`}} className='w-[415px] h-[454px] bg-cover bg-center rounded-[24px] text-white '>
          <p className='bg-white text-black relative m-[30px] float-end w-[127px] h-[54px] rounded-[12px] justify-center flex items-center text-[28px]'>$1.5m</p>
          <div className=' w-full m-[30px] relative top-[300px] '>
          <h1 className='whitespace-nowrap w-full text-[32px]'>Elegan stone home</h1>
          <p className=' w-full text-[24px]'>New York, USA</p>
          </div>
        ...
        <button className='text-[20px] w-[196px] h-[66px] rounded-[12px] bg-[#A0CAF5] '>See More</button>
        </div>
      ...
      <div style={{backgroundImage:`url(${bg})`}} className='bg-black bg-cover bg-center gap-[32px] rounded-[40px] h-[400px] w-[1400px] mx-auto my-[140px] flex flex-col justify-center items-center'>
        ...
        <h1 className='w-full text-center text-white text-[50px]  '>Choose your best home now,<br/> for the good of the family</h1>
        <div className='flex justify-center items-center '>
        <button className=' text-[20px] w-[196px] h-[66px] rounded-[12px] bg-[#A0CAF5]'>Get Started</button>
      ...
      <div className='w-[90%] mx-auto flex gap-[10px] my-[40px] h-[260px] justify-between items-center'>
        <div className='h-full flex justify-between flex-col '>
          <h1 className='text-[39px] font-bold  '>REZI_LINK</h1>
          <p className=' text-[#272727B2]'>Lorem ipsum dolor sit amet <br/> consectetur. Feugiat ac a risus et <br /> ullamcorper non.</p>
        ...
        <div className='grid grid-cols-3 gap-[90px] h-full'>
          <div className=' flex flex-col gap-[33px] text-[18px]'>
      ...
      <div className='w-full border-t-[1px] border-[#272727B2] p-[24px]'>
        <p className='text-center'>© Copyright 2022 Rezi-Link. All rights reserved.</p>
      </div>
